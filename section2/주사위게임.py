...
for i in range(N):
    ...
    temp.sort()
    print(temp)
    if temp[0]==temp[1] and temp[1]==temp[2]: #모두 맞았을 때
        money = 10000+temp[0]*1000
    elif temp[0]==temp[1] or temp[1]==temp[2]:# 2개 맞았을 때
        money = 1000+temp[0]*100
    elif temp[1]==temp[2]:# 2개 맞을때
        money = 1000+temp[1]*100
    else:# 1개도 안맞음
        money = temp[2]*100
